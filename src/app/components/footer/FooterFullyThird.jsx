...
import "./FooterFullyThird.css"
import { outdoordata } from './footerdata/outdoorsdata';
import Link from 'next/link';
import { RiArrowDropDownLine } from 'react-icons/ri';

const FooterFullyThird = () => {
    ...
    const displayedItems = showMore ? outdoordata : outdoordata.slice(0, 17);
  return (
...
export default FooterFullyThird